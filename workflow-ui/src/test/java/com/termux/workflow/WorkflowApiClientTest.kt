...
class WorkflowApiClientTest {
    ...
    fun trackerStateAndUsageRefreshUseAgreedContracts() = runTest {
        ...
        server.enqueue(
            MockResponse().setBody(
                """{"tasks":[],"usage":{"fetched_at":"2026-07-28T08:00:00Z","weekly_remaining":72.5,"reset_credit_expiries":["2026-08-01T08:00:00Z"],"daily_token_total":1200000,"codex_token_total":700000,"opencode_token_total":500000,"days":[{"day":"2026-07-28","codex":700000,"opencode":500000}],"opencode_projects":[{"name":"project-manager","path":"/repo/project-manager","total":9000000,"daily":4000000}],"codex_limits":[{"label":"Five-hour","remaining_percent":80,"used_percent":20,"reset_at":"2026-07-28T12:00:00Z"},{"label":"7d","remaining_percent":72.5,"used_percent":27.5,"reset_at":"2026-08-03T08:00:00Z"}]}}""",
            ),
        )
