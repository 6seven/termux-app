...
public final class TermuxPropertyConstants {
    ...
    public static final String DEFAULT_IVALUE_EXTRA_KEYS = "[['ESC','/',{key: '-', popup: '|'},'KEYBOARD','UP',{macro: 'ALT z', display: 'FS'},{macro: 'CTRL s x', display: 'CSX'}], ['TAB','CTRL','ALT','LEFT','DOWN','RIGHT','y']]"; // Double row
